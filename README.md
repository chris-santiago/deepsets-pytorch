...
Deep Sets is a universal architecture for learning permutation invariant and equivariant functions on sets. This implementation provides a complete, production-ready PyTorch implementation with comprehensive tests and examples.
